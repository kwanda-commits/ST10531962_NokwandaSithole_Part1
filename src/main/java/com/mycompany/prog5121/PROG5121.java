...
public class PROG5121 {
    ...
    public static void main(String[] args) {
        ...
        // Register user
        String registerMessage = PROG5121.registerUser(username, password);
        ...
        while (true) {
            ...
            status = PROG5121.loginUser(loginUser, loginPass, storedUsername, storedPassword);

            System.out.println(PROG5121.returnLoginStatus(status));
